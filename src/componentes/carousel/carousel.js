...
export const Carousel = () => {
    ...
    return (
        ...
        >
            ...
            >
                <a className="neon-button" href={imagen === "ecommerce-shoes"? "https://shoes-brian432.onrender.com/":`https://brian432.github.io/${imagen}`} target="_blank" rel="noopener noreferrer">Proyecto</a>
